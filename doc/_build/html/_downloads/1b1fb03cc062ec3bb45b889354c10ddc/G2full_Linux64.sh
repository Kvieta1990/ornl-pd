...
packages="python=$pyver wxpython numpy=$numpyver scipy matplotlib pyopengl conda anaconda-client git gitpython requests pillow h5py imageio scons cython seekpath sympy pybaselines pycifrw xmltodict zarr"
...
if [ "$gitinstall" = "True" ]; then
    ...
    git clone -b main $gitCodeRepo $WORKSPACE/GSAS2-code --depth 50
fi
...
def download_binaries():
    ...
    thetarfile = "https://powder.ornl.gov/files/linux_64_p3.11_n1.26.tgz"
...
python $WORKSPACE/GSAS2-code/GSASII/G2.py
